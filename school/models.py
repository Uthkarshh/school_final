...
class Fee(db.Model):
    ...
    pen_num = db.Column(db.BigInteger, db.ForeignKey('student.pen_num'), primary_key=True, nullable=False)
    year = db.Column(db.Integer, primary_key=True, nullable=False)
    school_fee = db.Column(db.Numeric(10, 2), nullable=False)
    concession_reason = db.Column(db.String(50), nullable=True)
    school_fee_concession = db.Column(db.Numeric(10, 2), nullable=False, default=0)
    transport_used = db.Column(db.Boolean, nullable=False, default=False)
    application_fee = db.Column(db.Numeric(10, 2), nullable=False)
    transport_fee = db.Column(db.Numeric(10, 2), nullable=True)
    transport_fee_concession = db.Column(db.Numeric(10, 2), nullable=True)
